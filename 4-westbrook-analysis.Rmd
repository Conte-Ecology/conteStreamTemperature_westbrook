...
(mean(ggs.wb[ggs.wb$Parameter == 'B.0[16]','value'])+mean(ggs.wb[ggs.wb$Parameter == 'B.0[17]','value'])) * 365
(mean(ggs.wb[ggs.wb$Parameter == 'B.0[16]','value'])+mean(ggs.wb[ggs.wb$Parameter == 'B.0[18]','value'])) * 365
(mean(ggs.wb[ggs.wb$Parameter == 'B.0[16]','value'])+mean(ggs.wb[ggs.wb$Parameter == 'B.0[19]','value'])) * 365
