...
# for ( i in 12 ){
  ...
  predictSummary <- rbind( predictSummary, data.frame( r=tempDataSyncS$river, year=tempDataSyncS$year, dOYInt = tempDataSyncS$dOYInt, rivsIndex=rivsIndex, scenario = k, yearOut = y, minDOY=minDOY, maxDOY=maxDOY,pred = tempDataSyncS$pred.wb, resid = tempDataSyncS$resid ) )
...
save( rmseByOut,rmseByOutAll,predictSummary,overlap,ggObsPred,ggCubic, file = paste0(dataLocalDir,'validation.RData'))
