...
system.time(M.wb <- modelRegionalTempWB(tempDataSyncS, firstObsRows, evalRows, data.fixed=data.fixed, data.random.years=data.random.years, n.burn = 200, n.it = 100, n.thin = 2, nc = 3, coda = coda.tf, param.list = monitor.params))
