...
# # ------------------------------------------------
# #e <- readStreamTempData(timeSeries = T, covariates = F, dataSourceList = dataSources, fieldListTS = tempFields, fieldListCD = covFields, directory = dataInDir )
# 
...
save(e, file=paste0(dataLocalDir,'e.RData'))
...
springFallBPs <- breaks[,c('site', 'year', 'finalSpringBP', 'sourceSpringBP', 'finalFallBP', 'sourceFallBP','quantileLo','quantileHi')]
